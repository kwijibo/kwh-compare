...
{
	if (region.a9.ax === region.br.ax)
	{
		return 'on line ' + region.a9.ax;
	}
	return 'on lines ' + region.a9.ax + ' through ' + region.br.ax;
}
...
var author$project$Main$CupOfTea = 3;
var author$project$Main$DrinksCan = 0;
var author$project$Main$EnergyUse = F5(
	function (label, useUnit, wattHours, info, icon) {
		return {aN: icon, bz: info, a3: label, aY: useUnit, bc: wattHours};
	});
var author$project$Main$Hour = 5;
var author$project$Main$IPhone6 = 1;
var author$project$Main$Mile = 2;
var author$project$Main$Minute = 6;
var author$project$Main$Model = F2(
	function (selected, energyUses) {
		return {bs: energyUses, F: selected};
	});
var author$project$Main$PopcornBag = 7;
var author$project$Main$WashingCycle = 4;
var author$project$Main$electricCar = A5(author$project$Main$EnergyUse, 'driving an electric car', 2, 250, 'Car energy efficiency figures based on a Nissan Leaf. A Tesla Model S will go 72% of this distance; a Renault Zoe will go 38% further! A 45pmg petrol car will get only 25% of this distance', 'car');
...
var author$project$Main$init = A2(
	...
	author$project$Main$electricCar,
	_List_fromArray(
		[
			author$project$Main$electricCar,
			A5(author$project$Main$EnergyUse, 'lighting an LED spotlight', 5, 5, '5w spot light, providing 346 lumens, equivalent to a 50w incandescent', 'bulb'),
			A5(author$project$Main$EnergyUse, 'made from new aluminium', 0, 140, 'Recycled aluminium would require only 5% of the energy', 'can'),
			A5(author$project$Main$EnergyUse, 'cooling a fridge-freezer', 5, 18.26, 'With a Miele A+++ 300l Fridge-Freezer. A modern fridge uses between 40 and 60% less energy than models sold before 2000. An A+ model uses 20% less energy than an A-rated fridge-freezer. An A++ uses about 40% less. Stacked fridge-freezers are about 20% more efficient than American-style side-stacked models.', 'fridge'),
			A5(author$project$Main$EnergyUse, 'riding an e-bike', 2, 10.989, 'With a Bosch Active Line drive system, used in \"Turbo\" mode, with an average speed of 14mph. In \"eco\" mode, it would use less than 40% of this energy - about 4 watts a mile.', 'bike'),
			A5(author$project$Main$EnergyUse, 'watching TV', 5, 50, 'With an A++ TV consuming 50w an hour', 'tv'),
			A5(author$project$Main$EnergyUse, 'of tea', 3, 33, 'Boiling the water in a normal 3kW kettle', 'kettle'),
			A5(author$project$Main$EnergyUse, 'of popcorn', 7, 27, 'Popped in an 800w microwave', 'microwave'),
			A5(author$project$Main$EnergyUse, 'cooking on an induction hob', 6, 33.333, 'With a 2kW induction hob', 'cooker'),
			A5(author$project$Main$EnergyUse, 'taking a shower', 6, 158.3333, 'With a 9.5kW electric shower', 'shower'),
			A5(author$project$Main$EnergyUse, 'vacuuming', 6, 15, 'With a 900w compact vacuum cleaner', 'vacuum'),
			A5(author$project$Main$EnergyUse, 'charging to full', 1, 22, 'Newer larger iPhones require more energy to charge', 'phone'),
			A5(author$project$Main$EnergyUse, 'using a laptop', 5, 58.4, 'Based on an Apple MacBook Pro 15\" (2.9 GHz)', 'laptop'),
			A5(author$project$Main$EnergyUse, 'washing machine on Baby Care (60ºC)', 4, 2200, 'The cycle lasts for 3 hours.', 'washing')
		]));
...
var Skinney$murmur3$Murmur3$HashData = F4(
	function (shift, seed, hash, charsProcessed) {
		return {U: charsProcessed, _: hash, O: seed, ah: shift};
	});
...
var Skinney$murmur3$Murmur3$finalize = function (data) {
	var acc = data._ ? (data.O ^ A2(
		Skinney$murmur3$Murmur3$multiplyBy,
		Skinney$murmur3$Murmur3$c2,
		A2(
			Skinney$murmur3$Murmur3$rotlBy,
			15,
			A2(Skinney$murmur3$Murmur3$multiplyBy, Skinney$murmur3$Murmur3$c1, data._)))) : data.O;
	var h0 = acc ^ data.U;
...
var Skinney$murmur3$Murmur3$hashFold = F2(
	function (c, data) {
		var res = data._ | ((255 & elm$core$Char$toCode(c)) << data.ah);
		var _n0 = data.ah;
		if (_n0 === 24) {
			return {
				U: data.U + 1,
			...
			return {U: data.U + 1, _: res, O: data.O, ah: data.ah + 8};
		}
	});
...
var rtfeldman$elm_css$Css$Preprocess$stylesheet = function (snippets) {
	return {bo: elm$core$Maybe$Nothing, bx: _List_Nil, bE: _List_Nil, bR: snippets};
};
...
var rtfeldman$elm_css$Css$Preprocess$Resolve$toStructure = function (_n0) {
	...
	var declarations = rtfeldman$elm_css$Css$Preprocess$Resolve$extract(
		A2(elm$core$List$concatMap, rtfeldman$elm_css$Css$Preprocess$unwrapSnippet, snippets));
	return {bo: charset, b4: declarations, bx: imports, bE: namespaces};
};
...
var rtfeldman$elm_css$Css$Structure$compactStylesheet = function (_n0) {
	...
	return {bo: charset, b4: finalDeclarations, bx: imports, bE: namespaces};
};
...
var author$project$Main$bigStrong = function (txt) {
	return A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						rtfeldman$elm_css$Css$pt(38)),
						rtfeldman$elm_css$Css$color(
						rtfeldman$elm_css$Css$hex('#5779A8')),
...
var author$project$Main$Entry = F3(
	function (energyUse, num, unitName) {
		return {at: energyUse, ay: num, bX: unitName};
	});
var author$project$Main$unitName = function (x) {
	switch (x) {
		case 5:
			return 'hour';
		case 6:
...
var author$project$Main$makeEntry = F2(
	function (selectedWattHours, energyUse) {
		var num = selectedWattHours / energyUse.bc;
		var _n0 = energyUse.aY;
		switch (_n0) {
			case 5:
				return (_Utils_cmp(num, 1 / 60) < 0) ? A3(author$project$Main$Entry, energyUse, (num * 60) * 60, 'second') : ((num < 1) ? A3(author$project$Main$Entry, energyUse, num * 60, 'minute') : ((num >= 24) ? A3(author$project$Main$Entry, energyUse, num / 24, 'day') : A3(author$project$Main$Entry, energyUse, num, 'hour')));
			case 6:
				return (num < 1) ? A3(author$project$Main$Entry, energyUse, num * 60, 'second') : ((_Utils_cmp(num, 60 * 24) > -1) ? A3(author$project$Main$Entry, energyUse, num / (60 * 24), 'day') : ((num >= 60) ? A3(author$project$Main$Entry, energyUse, num / 60, 'hour') : A3(author$project$Main$Entry, energyUse, num, 'minute')));
			default:
				return A3(
					author$project$Main$Entry,
					energyUse,
					num,
					author$project$Main$unitName(energyUse.aY));
		}
	});
...
var author$project$Main$makeIcon = function (name) {
	return A2(
		rtfeldman$elm_css$Html$Styled$img,
		_List_fromArray(
			[
				rtfeldman$elm_css$Html$Styled$Attributes$src('icons/' + (name + '.png')),
				rtfeldman$elm_css$Html$Styled$Attributes$css(
				_List_fromArray(
					[
...
var author$project$Main$roundish = function (n) {
	return (n < 0.9) ? (A2(myrho$elm_round$Round$round, 0, n * 100) + '%') : (((n < 2) && (!_Utils_eq(
		n,
		elm$core$Basics$round(n)))) ? A2(myrho$elm_round$Round$round, 0, n) : A2(myrho$elm_round$Round$round, 0, n));
};
var elm$core$List$sortBy = _List_sortBy;
var rtfeldman$elm_css$Css$auto = {b_: 0, a: 0, X: 0, aO: 0, cc: 0, ab: 0, B: 0, t: 0, ae: 0, q: 0, aW: 0, al: 0, o: 0, v: 'auto'};
...
var rtfeldman$elm_css$Css$dotted = {m: 0, P: 0, v: 'dotted'};
...
var rtfeldman$elm_css$Css$italic = {Y: 0, v: 'italic'};
var rtfeldman$elm_css$Css$larger = {k: 0, v: 'larger'};
var rtfeldman$elm_css$Css$left = rtfeldman$elm_css$Css$prop1('left');
var rtfeldman$elm_css$Css$lighter = {A: 0, v: 'lighter'};
var rtfeldman$elm_css$Css$margin = rtfeldman$elm_css$Css$prop1('margin');
var rtfeldman$elm_css$Css$marginRight = rtfeldman$elm_css$Css$prop1('margin-right');
var rtfeldman$elm_css$Css$marginTop = rtfeldman$elm_css$Css$prop1('margin-top');
var rtfeldman$elm_css$Css$none = {S: 0, bk: 0, m: 0, a: 0, f: 0, b9: 0, bA: 0, a2: 0, ad: 0, K: 0, t: 0, c: 0, b: 0, a5: 0, aS: 0, ci: 0, q: 0, aT: 0, ck: 0, aj: 0, Q: 0, o: 0, e: 0, cp: 0, v: 'none'};
var rtfeldman$elm_css$Css$normal = {a0: 0, Y: 0, A: 0, a7: 0, v: 'normal', H: 0};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						rtfeldman$elm_css$Css$width(
						rtfeldman$elm_css$Css$pct(85)),
						rtfeldman$elm_css$Css$margin(rtfeldman$elm_css$Css$auto),
						rtfeldman$elm_css$Css$color(
						A3(rtfeldman$elm_css$Css$rgb, 14, 15, 16)),
						rtfeldman$elm_css$Css$fontSize(
						rtfeldman$elm_css$Css$pt(22)),
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						author$project$Main$bigStrong('1 '),
						rtfeldman$elm_css$Html$Styled$text(
						author$project$Main$unitName(model.F.aY) + ' '),
						A2(
						rtfeldman$elm_css$Html$Styled$strong,
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										...
										rtfeldman$elm_css$Css$color(
										rtfeldman$elm_css$Css$hex('#5779DD')),
										rtfeldman$elm_css$Css$padding(
										rtfeldman$elm_css$Css$em(0.25))
									]))
							]),
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$text(model.F.a3)
							])),
						author$project$Main$makeIcon(model.F.aN),
						rtfeldman$elm_css$Html$Styled$text(' uses the same energy as:')
					])),
				A2(
				rtfeldman$elm_css$Html$Styled$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										rtfeldman$elm_css$Css$color(
										rtfeldman$elm_css$Css$hex('#149FEB')),
										rtfeldman$elm_css$Css$fontSize(
										rtfeldman$elm_css$Css$pt(70)),
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$text('ℹ')
							])),
						A2(
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$text(model.F.bz)
							]))
					])),
				A2(
				rtfeldman$elm_css$Html$Styled$div,
				...
				A2(
					...
					function (entry) {
						return A2(
							...
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$Attributes$class(entry.at.aN),
									rtfeldman$elm_css$Html$Styled$Attributes$css(_List_Nil)
								]),
							_List_fromArray(
								[
									author$project$Main$bigStrong(
									author$project$Main$roundish(entry.ay)),
									rtfeldman$elm_css$Html$Styled$text(
									_Utils_ap(
										(entry.ay < 1) ? ' of a ' : ' ',
										_Utils_ap(
									...
									_List_fromArray(
										[
											rtfeldman$elm_css$Html$Styled$Events$onClick(entry.at),
											rtfeldman$elm_css$Html$Styled$Attributes$href('#'),
											rtfeldman$elm_css$Html$Styled$Attributes$css(
											_List_fromArray(
												[
													rtfeldman$elm_css$Css$color(
													rtfeldman$elm_css$Css$hex('#5779B7')),
													rtfeldman$elm_css$Css$textDecoration(rtfeldman$elm_css$Css$none)
												]))
										]),
									_List_fromArray(
										[
											rtfeldman$elm_css$Html$Styled$text(entry.at.a3 + '  '),
											author$project$Main$makeIcon(entry.at.aN)
										]))
								]));
					},
					elm$core$List$reverse(
						A2(
							...
							A2(
								elm$core$List$map,
								author$project$Main$makeEntry(model.F.bc),
								A2(
									elm$core$List$filter,
									function (eu) {
										return !_Utils_eq(eu, model.F);
									},
									model.bs))))))
			]));
};
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bv: fragment, bw: host, bG: path, bI: port_, bL: protocol, bM: query};
	});
